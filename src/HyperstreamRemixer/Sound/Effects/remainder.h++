...
inline void Remainder::apply(Unit<wf_amplitude_t> &audio_buffer, const wf_channels_t channels, const wf_sample_rate_t sample_rate) {
    ...
    std::memcpy(new_audio_buffer, *audio_buffer, old_audio_length * sizeof(wf_amplitude_t));
